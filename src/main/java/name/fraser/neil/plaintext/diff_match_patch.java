...
public class diff_match_patch {
  ...
  /**
   * Split two texts into a list of strings.  Reduce the texts to a string of
   * hashes where each Unicode words represents one line.
   * @param text1 First string.
   * @param text2 Second string.
   * @return An object containing the encoded text1, the encoded text2 and
   *     the List of unique strings.  The zeroth element of the List of
  ...
  public LinkedList<Diff> diff_WordMode(String text1, String text2) {
	  ...
	  LinesToCharsResult lines = diff_linesToWords(text1, text2);
	  String lineText1 = lines.chars1;
	  String lineText2 = lines.chars2;
	  List<String> lineArray = lines.lineArray;
	  
	  LinkedList<diff_match_patch.Diff> diffs = diff_main(lineText1, lineText2, false);
	  diff_charsToLines(diffs, lineArray);
	  return diffs;
  }
