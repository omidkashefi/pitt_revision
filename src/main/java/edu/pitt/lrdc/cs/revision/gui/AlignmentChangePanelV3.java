...
public class AlignmentChangePanelV3 extends JPanel {
	...
	public AlignmentChangePanelV3(RevisionDocument doc, RevisionUnit ru) {
		this(doc, ru.getOldSentenceIndex(), ru.getNewSentenceIndex());
	}

	public AlignmentChangePanelV3(RevisionDocument doc,
