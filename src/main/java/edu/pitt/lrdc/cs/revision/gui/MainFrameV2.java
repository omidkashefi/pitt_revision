...
public class MainFrameV2 extends JFrame {
	...
	RevisionDocument rd;
	private AdvBaseLevelPanelV2 panel;
	...
	public MainFrameV2() {
		...
		saveItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (isSuccess) {
						JOptionPane.showMessageDialog(MainFrameV2.this,
								"File saved.");
					} else {
						JOptionPane.showMessageDialog(MainFrameV2.this,
								"File save fail!");
		...
		item.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				int returnVal = fc.showOpenDialog(MainFrameV2.this);

				if (returnVal == JFileChooser.APPROVE_OPTION) {
					File file = fc.getSelectedFile();
					try {
						MainFrameV2.this.load(file.getAbsolutePath());
		...
		item2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (returnVal == JFileChooser.APPROVE_OPTION) {
					...
					try {
						panel.registerRevision();
						boolean isSuccess = MainFrameV2.this.export(file
								.getAbsolutePath());
						if (isSuccess) {
							JOptionPane.showMessageDialog(MainFrameV2.this,
									"File saved.");
	...
	public void loadFromService(String serverAddress, String username)
		...
		MainFrameV2.this.load(ff.getAbsolutePath());
	...
	public void load(String path) throws Exception {
		 ...
		 */
		if (panel == null) {
			panel = new AdvBaseLevelPanelV2(rd);
			// this.add(panel);
		} else {
			this.remove(panel);
			panel = new AdvBaseLevelPanelV2(rd);
	...
	public static void main(String[] args) throws Exception {
		...
		MainFrameV2 mf = new MainFrameV2();
		// mf.load("dummy");
		mf.show();
